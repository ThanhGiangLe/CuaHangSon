...
slider.querySelector(".controls .up").addEventListener("click", function () {
    ...
    currentSlide--;
    slider.querySelector(".wrapper .left div").style.marginTop = `${currentSlide * -50
        }vh`;
    slider.querySelector(".wrapper .right div").style.marginTop = `${(totalSlides - currentSlide) * -50
        }vh`;
});
